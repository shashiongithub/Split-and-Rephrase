...
if __name__ == "__main__":
    ...
    f_sym_train_compsem = open(
        "mymodel/generation-module/train.complex-semantics", "w")
    f_sym_train_simple = open("mymodel/generation-module/train.simple", "w")
    f_sym_train_simpsem = open(
        "mymodel/generation-module/train.simple-semantics", "w")

    f_sym_validation_complex = open(
        "mymodel/generation-module/validation.complex", "w")
    f_sym_validation_compsem = open(
        "mymodel/generation-module/validation.complex-semantics", "w")
    f_sym_validation_simple = open(
        "mymodel/generation-module/validation.simple", "w")
    f_sym_validation_simpsem = open(
        "mymodel/generation-module/validation.simple-semantics", "w")

    f_sym_test_complex = open("mymodel/generation-module/test.complex", "w")
    f_sym_test_compsem = open(
        "mymodel/generation-module/test.complex-semantics", "w")
    f_sym_test_simple = open("mymodel/generation-module/test.simple", "w")
    f_sym_test_simpsem = open(
        "mymodel/generation-module/test.simple-semantics", "w")
